  ...
  return (
    <div className="space-y-6">
      ...
      <EffectCard
        ...
        onToggle={(enabled) => onUpdateEffect('speakerOptimizationEnabled', enabled)}
        icon={<SpeakerIcon />}
      >
        <p className="text-sm text-dark-400">Optimizes audio output for built-in speakers by enhancing clarity and presence.</p>
      </EffectCard>
